...
puts "=> Test QUERY PARAMS Pact"
res = `bundle exec bin/pact-provider-verifier -a "1.0.100" --provider-base-url http://localhost:4567 --pact-urls ./test/query-params.json --provider_states_setup_url http://localhost:4567/provider-state -v`
puts res
